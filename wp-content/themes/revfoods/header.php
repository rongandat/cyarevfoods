...
<body <?php body_class(); ?>>
    <div id="page" class="hfeed site">
        <header id="masthead" class="site-header" role="banner">
            <div class="site-header-1 pfixed" style="<?php if (is_user_logged_in()) {
            echo "top:28px;";
        } ?>" >
<?php wp_nav_menu(array('theme_location' => 'Top-Menu-1', 'container' => '', 'after' => '<span></span>', 'menu_class' => 'top-menu-1')); ?>
            </div>
            <div class="site-header-2 pfixed" style="<?php if (is_user_logged_in()) {
    echo "top:48px;";
} ?>">
...
<?php wp_nav_menu(array('theme_location' => 'Top-Menu-2', 'container' => '', 'menu_class' => 'top-menu-2 fl')); ?>
            ...
            <div class="site-header-3 pfixed" style="<?php if (is_user_logged_in()) {
                        echo "top:151px;";
                    } ?>">
