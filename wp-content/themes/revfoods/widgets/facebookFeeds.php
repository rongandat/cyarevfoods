...
class FacebookPageFeedWidget extends WP_Widget {
    ...
    function FacebookPageFeedWidget() {
        ...
        parent::WP_Widget(false, $name = 'Rev foods facebook feeds');
    }
    ...
    function form($instance) {
        $default['title'] = __('Facebook', 'fbf');
        $default['pageID'] = '154956628003837';
        ...
        $default['link'] = 'https://www.facebook.com/RevolutionFoods';
        $default['link_text'] = 'join the conversation';
