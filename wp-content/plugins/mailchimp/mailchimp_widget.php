...
function mailchimpSF_signup_form($args = array()) {
    ...
    font-size: <?php echo  $args['headline_font_size']?>;
    color: <?php echo  $args['headline_font_color']?>;
    text-align: left;
    padding-bottom: 0px;
}
    </style>
        ...
        <div class="main_content">
            <div class="content">
                <form method="post" action="#mc_signup" id="mc_signup_form">
                    ...
                    <p class="content"><?php echo $args['content'] ?></p>
                    <div class="form">
                                    ...
                                    if ($igs && get_option('mc_show_interest_groups_' . $ig['id']) == 'on') {
                                        if ($ig['form_field'] != 'hidden') {
                                            ...
                                            <div class="send_info">
                                                ...
                                                <?php mailchimp_interest_group_field($ig); ?>
                                            </div>
                                            <?php
                                        }
                                    }
    ...
    switch ($ig['form_field']) {
        ...
        case 'checkboxes':
            ...
            foreach ($ig['groups'] as $interest) {
                ...
                $html .='<input class="css-checkbox" type="checkbox" name="' . esc_attr($set_name . '[' . $i . ']') . '" id="' . esc_attr('mc_interest_' . $ig['id'] . '_' . $interest) . '">
<label class="css-label" for="' . esc_attr('mc_interest_' . $ig['id'] . '_' . $interest) . '">' . esc_html($interest) . '</label>';
...
<div class="mc_merge_var">
	...
	<input type="text" size="4" maxlength="4" value="" name="' . esc_attr($opt . '[detail2]') . '" id="' . esc_attr($opt . '-detail2') . '" class="mc_input mc_phone" />
            ...
            default:
                $html .= '
	<input type="text" size="18"  placeholder="' . esc_html($var['name']) . '" value="' . esc_html($var['default']) . '" name="' . esc_attr($opt) . '" id="' . esc_attr($opt) . '" class="st-forminput"/>';
                break;
        }
